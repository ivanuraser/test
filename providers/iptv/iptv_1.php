...
<div class="row page-title text-center">
    <p class="h2">Тарифы <span>IPTV</span> от провайдера MNS
    <?php if ((isset($street_name)) && (isset($house)))	{ 
						echo 'по адресу <span>'.$street_name.', '.$house.'</span>';
					}?>
    :</p>
    <p class="h2">Отдел подключений <?php echo $phone_mns; ?></p>
</div>
<div class="row jobs">
    <div class="col-lg-12">
        <div class="job-posts table-responsive">
            <table class="table">
                <tr class="odd" >
                    ...
                    <td class="tbl-apply"><button class="btn" name="plan_id" value="7">ПОДКЛЮЧИТЬ</button></td>
                </tr>
                <tr class="even">
                    <td class="tbl-logo"><img src="img/providers/mns.jpg" class="img-thumbnail" alt="Подключить интернет MNS" title="Подключить интернет MNS"></td>
                    ...
                    <td class="tbl-description"><p>Подключение бесплатное. ТВ-приставка предоставляется в аренду по 10 руб./мес.</p></td>
                    <td class="tbl-icon"><img src="img/icons/tv.png" width="60px" alt="" title=""></td>
                    <td class="tbl-apply"><button class="btn" name="plan_id" value="8" title="Подключить интернет MNS">ПОДКЛЮЧИТЬ</button></td>
                </tr>
                <tr class="odd" >
                    <td class="tbl-logo"><img src="img/providers/mns.jpg" alt="" class="img-thumbnail"></td>
                    ...
                    <td class="tbl-description"><p>Подключение бесплатное. ТВ-приставка предоставляется в аренду по 10 руб./мес.</p></td>
                    <td class="tbl-icon"><img src="img/icons/tv.png" width="60px" alt="" title=""></td>
                    <td class="tbl-apply"><button class="btn" name="plan_id" value="9">ПОДКЛЮЧИТЬ</button></td>
                </tr>
            </table>
        </div>
	</div>
